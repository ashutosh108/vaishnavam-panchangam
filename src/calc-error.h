...
struct NoJayantiOnThisHalfMasa {
};

using CalcError = std::variant<CantFindSunriseAfter, CantFindSunriseBefore, CantFindSunsetAfter, CantFindLocation, NoRohiniAshtamiIntersectionForJayanti, NoJayantiOnThisHalfMasa>;
